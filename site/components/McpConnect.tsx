...
// A solid pill showing the MCP server URL with a copy button. Used on the
// landing hero.
export default function McpConnect({
  ...
  return (
    <div className={`flex w-fit max-w-full flex-col items-center ${className}`}>
      ...
      <div className="flex w-full items-center gap-3 rounded-lg border border-white/15 bg-neutral-900 px-4 py-2">
